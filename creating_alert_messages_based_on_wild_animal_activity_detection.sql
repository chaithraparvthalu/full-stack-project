...
--
-- Host: localhost
-- Generation Time: Oct 05, 2023 at 11:53 AM
...
--
-- Database: `creating_alert_messages_based_on_wild_animal_activity_detection`
--
CREATE DATABASE IF NOT EXISTS `creating_alert_messages_based_on_wild_animal_activity_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `creating_alert_messages_based_on_wild_animal_activity_detection`;
...
('079hm8feiuinweah23d1lnynqqinzly1', 'eyJ1c2VyaWQiOjJ9:1ql5qC:ZRddeEHndymvSukSjYaHtYoyhY5QsY2qo1G7lf4_-dA', '2023-10-10 11:02:56.236989'),
...
('ctx1rgbj9ressx7fjs6wzddl6i4ewyfo', 'eyJ1c2VyaWQiOjF9:1ql4jI:pimFnPUCTk8qhlwGtGd2wlIVE6bx0OO5eyETnZuMFdc', '2023-10-10 09:51:44.323020'),
...
(1, 'Ashwin', 'Ashwin123@gmail.com', 'Ashwin', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(10, 'Convolutional Neural Network (CNN)', '41.46341463414634'),
(11, 'SVM', '39.02439024390244'),
(12, 'Logistic Regression', '41.46341463414634'),
(13, 'Decision Tree Classifier', '46.34146341463415'),
(14, 'KNeighborsClassifier', '36.58536585365854');
...
(10, 'crossing the forest lines', '20.0'),
(11, 'hindrance to villagers and  tourists people', '20.0'),
(12, 'detection of trespassing', '60.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_animal_activity_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_animal_activity_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Forest_Name` varchar(300) NOT NULL,
  ...
  `Predators` varchar(300) NOT NULL,
  `Countries_Found` varchar(300) NOT NULL,
  `Conservation_Status` varchar(300) NOT NULL,
  `Family` varchar(300) NOT NULL,
  `Social_Structure` varchar(300) NOT NULL,
  `Alert_Message_Date` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `remote_user_predict_animal_activity_detection`
--

INSERT INTO `remote_user_predict_animal_activity_detection` (`id`, `Fid`, `Forest_Name`, `Location`, `Animal`, `Height_cm`, `Weight_kg`, `Color`, `Diet`, `Habitat`, `Predators`, `Countries_Found`, `Conservation_Status`, `Family`, `Social_Structure`, `Alert_Message_Date`, `Prediction`) VALUES
(1, '192.229.173.173-10.42.0.151-80-57987-6', 'Cotigao Wildlife Sanctuary ', 'Canacona taluk, Goa', 'Anteater', '52-91', '22-41', 'Brown, White', 'Insectivore', 'Grasslands, Forests', 'Jaguars, Pumas', 'India', 'Least Concern', 'Myrmecophagidae', 'Solitary', '12-03-15 6:53', 'detection of trespassing'),
(2, '10.42.0.151-10.42.0.1-45805-53-17', 'Keibul Lamjao National Park', 'Bishnupur district, Manipur', 'Asian Elephant', '200-300', '2000-5000', 'Grey', 'Herbivore', 'Grasslands, Forests', 'Tigers, Leopards', 'India', 'Endangered', 'Elephantidae', 'Herd-based', '03-03-20 10:17', 'detection of trespassing'),
(5, '163.177.93.222-10.42.0.151-80-46812-6', 'Bhagwan Mahaveer Sanctuary and Mollem National Park', 'Sanguem taluk, Goa', 'Alpine Ibex', '67-101', '19-120', 'Brown', 'Herbivore', 'Mountains, Alpine', 'Wolves, Golden Eagles', 'India', 'Least Concern', 'Bovidae', 'Group-based', '28-12-19 23:45', 'crossing the forest lines'),
(6, '202.77.129.230-10.42.0.151-80-47935-6', 'Bondla Wildlife Sanctuary', 'Ponda taluk, Goa', 'American Bison', '152-186', '318-1,000', 'Brown', 'Herbivore', 'Grasslands, Plains', 'Wolves, Grizzly Bears', 'India', 'Near Threatened', 'Bovidae', 'Group-based', '30-07-20 19:20', 'hindrance to villagers and  tourists people'),
(7, '172.217.12.132-10.42.0.151-443-33413-6', 'Kukrail Reserve Forest', 'Lucknow, Uttar Pradesh', 'Bonobo', 'Up to 150', '30-40', 'Black', 'Omnivore', 'Rainforests', 'Leopards, Humans', 'India', 'Endangered', 'Hominidae', 'Social groups', '01-10-21 10:36', 'detection of trespassing');
